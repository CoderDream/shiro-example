...
public class CodecAndCryptoTest {
	...
	public void testBlowfishCipherService() {
		...
		// 加密
		String encrptText = blowfishCipherService
				.encrypt(text.getBytes(), key.getEncoded()).toHex();
		// 解密
		String text2 = new String(blowfishCipherService
				.decrypt(Hex.decode(encrptText), key.getEncoded()).getBytes());
	...
	public void testDefaultBlockCipherService() throws Exception {
		...
		DefaultBlockCipherService cipherService = new DefaultBlockCipherService(
				"AES");
		...
		// 加密
		String encrptText = cipherService
				.encrypt(text.getBytes(), key.getEncoded()).toHex();
		// 解密
		String text2 = new String(cipherService
				.decrypt(Hex.decode(encrptText), key.getEncoded()).getBytes());
